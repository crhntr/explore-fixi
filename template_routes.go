...
func TemplateRoutes(mux *http.ServeMux, receiver RoutesReceiver) TemplateRoutePaths {
	pathsPrefix := ""
	mux.HandleFunc("GET /count", func(response http.ResponseWriter, request *http.Request) {
		...
		if err := templates.ExecuteTemplate(buf, "GET /count Count()", &td); err != nil {
